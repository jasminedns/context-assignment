                    ...
                    <div className="flex flex-row flex-wrap gap-5 justify-center">
                        {
                            category.map((item, index) => 
                                <div 
                                    ...
                                    className="hover:bg-[#d9d4ca] w-[30%] border-1 border-[#26252246] rounded-4xl flex flex-col justify-center items-center"
                                >
                                    <img src={item.strCategoryThumb} alt={item.strCategory} className="m-3"/>
                                    <h2 className="font-bold cursor-pointer uppercase my-4">{item.strCategory}</h2>
                                </div>
                            )
                        }
                    </div>
